    ...
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper
          ...
          pb-24 pt-10 
          sm:pb-32 
          lg:grid lg:grid-cols-3 lg:gap-x-0 lg:pt-24 lg:pb-52
          xl:pt-32 xl:gap-x-8 
          `}
        >
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  design. Had the case two and half months now and{' '}
        ...
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              <Image
                src="/arrow.png"
                className="absolute top-[25rem] w-32 md:top-1/2 -translate-y-1/2 z-10 left-1/2 -translate-x-1/2 rotate-90 md:rotate-0"
                height={1000}
                width={1000}
                alt="Arrow image"
              />
