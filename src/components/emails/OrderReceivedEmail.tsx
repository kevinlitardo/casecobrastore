...
const OrderReceivedEmail = ({ shippingAddress, orderId, orderDate }: Props) => {
  const baseUrl =
    process.env.NODE_ENV === 'development'
      ? 'http://localhost:3000'
      : 'https://casecobrastore.vercel.app';

  return (
    <Html>
      <Head />
      <Preview>Your order summary and estimated deilvery date</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={{ ...global.text, marginTop: 24 }}>
              If you have any questions regardind your order, please feel free
